...
**Changelog:** v0.2.1 → v0.2.2: Council audit (Guardian ADM-EC). Config example aligned with code (driver_mode, auth defaults, admin_console). Phase 2 Level A deviation annotated. T4 "queued" removed. Lock expiry audit logging specified.
